...
ActiveRecord::Schema[8.0].define(version: 2024_12_21_164000) do
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["table_id", "email"], name: "index_players_on_table_id_and_email", unique: true, where: "email IS NOT NULL"
